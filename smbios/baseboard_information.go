...
func NewBaseboardInformation(s *smbios.Structure) *BaseboardInformation {
	return &BaseboardInformation{
		Manufacturer:      *GetString(s, 0x04),
		Product:           *GetString(s, 0x05),
		Version:           *GetString(s, 0x06),
		SerialNumber:      *GetString(s, 0x07),
		AssetTag:          GetString(s, 0x08),
		LocationInChassis: GetString(s, 0x0A),
